## code to prepare `table_string_operations` dataset goes here
...
table_string_operations <- dplyr::bind_rows(table_string1, table_string2)
usethis::use_data(table_string_operations, overwrite = TRUE)
